      ...
      <div className="form-row">
        <div className="col-5">
            <input type="text" className="form-control" placeholder="Pizza Topping" 
                   value={props.toppingVal} onChange={props.topping}/>
        </div>
        <div className="col">
          <select value={props.sizeVal} className="form-control"
                  onChange={props.size}>
        ...
        <div className="col">
          <div className="form-check">
            <input className="form-check-input" type="radio" value="Vegetarian" 
                   checked={props.vegetarianVal} onChange={props.vegetarian}/>
          ...
          <div className="form-check">
            <input className="form-check-input" type="radio" value="Not Vegetarian" 
                   checked={props.vegetarianVal === false} onChange={props.vegetarian}/>
            <label className="form-check-label">
              Not Vegetarian
            </label>
          </div>
